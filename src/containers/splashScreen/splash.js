                ...
                {this.state.shouldTryAgain && (
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <View style={{ flex: 80, width: wp(100)}}>
                            <ImageBackground source={CONNECTION_ERROR_SHADOW} resizeMode={'stretch'} style={{flex: 1}}>
                                <View style={{ flex: 80, justifyContent: 'flex-start', alignItems: 'center'}}>
                                    <View style={styles.tryAgainImgContainer}>
                                        <Image source={CONNECTION_ERROR_COLORED} style={styles.connectionErrorColoredImg}/>
                                    </View>
