                    ...
                    <View style={styles.premiumModal}>
                        ...
                        <View style={styles.premiumModalView}>
                            <LinearGradient
                                ...
                                style={styles.linearGradientPremiumModalView}
                            >
                                <View style={styles.premiumModalHeaderView}>
                                    <Text style={styles.premiumModalHeaderText}>
                                        ELİT ÖĞRENCİ PAKETİ
                                    </Text>
                                </View>
                                <View
                                    style={styles.premiumModalSwiperContainer}
                                >
                                    <Swiper
                                        autoplay={true}
                                        loop={true}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    Her gün verilen jokerlerle
                                                    soruların cevabına 1 adım
                                                    daha yaklaş, rakiplerinin
                                                    önüne geç
                                                </Text>
                                            </View>
                                        </View>
                            ...
                            <View style={styles.swiperView}>
                                <TouchableOpacity style={styles.bundleView}>
                                    <View style={styles.totalJokerAmountView}>
                                        <Text style={styles.jokerAmountsText}>
                                            30 Joker
                                        </Text>
                                    </View>
                                    ...
                                    <View
                                        style={styles.purchaseJokerButtonView}
                                    >
                                        <TouchableOpacity
                                            style={styles.purchaseJokerButton}
                                        >
                                            <Text
                    ...
                    this.props.clientInformation.isPremium === false &&
                        <View style={{flex: 47.5, width: wp(93)}}>
                            <View style={styles.adsContainer}>
                                <TouchableOpacity>
                                    <Image source={FIRST_JOKER_AD_BUTTON_2} style={styles.adButton2}/>
                                </TouchableOpacity>
                                <TouchableOpacity>
                                    <Image source={SECOND_JOKER_AD_BUTTON_2} style={styles.adButton2}/>
                                </TouchableOpacity>
                                <TouchableOpacity>
                                    <Image source={THIRD_JOKER_AD_BUTTON_2} style={styles.adButton2}/>
                                </TouchableOpacity>
                            </View>
                ...
                }
                {
                    this.props.clientInformation.isPremium &&
                        <View style={styles.premiumUserAddButtonsContainer}>
                            <TouchableOpacity>
                                <Image source={FIRST_JOKER_AD_BUTTON} style={styles.premiumUserJokerButtonStyle}/>
                            </TouchableOpacity>
                            <TouchableOpacity>
                                <Image source={SECOND_JOKER_AD_BUTTON} style={styles.premiumUserJokerButtonStyle}/>
                            </TouchableOpacity>
                            <TouchableOpacity>
                                <Image source={THIRD_JOKER_AD_BUTTON} style={styles.premiumUserJokerButtonStyle}/>
                            </TouchableOpacity>
                        </View>
                }
                    ...
                    <View style={styles.socialMediaView}>
                        ...
                        <View style={styles.socialMediaInfoView}>
                            <Text style={styles.socialMediaInfoText}>
                                Sosyal medya hesaplarımızı takip ederek ödülleri
                                ve en güncel haberleri kaçırma!
                            </Text>
                        </View>
                    </View>
                </View>
